...
//                System.out.println("Fila "+i+" - Columna: "+j+" es: "+matriz[i][j]);
    ...
    public void subsetSum(int array[]){
        ...
        startTime = System.currentTimeMillis();//para tener el tiempo de cuando es solo positivos o solo negativos
        if (sumaNegativos==0){
        ...
        System.out.print("Tiempo total: "+endTime+" milisegundos.\t");
...
//se copia el valor de arriba de la fila)
    ...
    public static void main(String[] args){
        ...
        //int [] array = generarArrayRandom(3,-100,100);
        //int [] array = {-1,2,3,4};
        int [] array={-2,2};
        //int [] array={-3,1,2,4};
...
//                System.out.println("Fila "+i+" - Columna: "+j+" es: "+matriz[i][j]);
    ...
    public void subsetSum(int array[]){
        ...
        if (sumaNegativos==0){
            long startTime = System.currentTimeMillis();//para tener el tiempo de cuando es solo positivos o solo negativos
            subconjunto.add(array[0]);//Agrega el menor de los positivos
